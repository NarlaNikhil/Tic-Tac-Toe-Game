...
initaiting_window = pygame.image.load("C:/Users/nikhil/Downloads/tic tac toe 2.jpg")
initaiting_window = pygame.transform.scale(initaiting_window, ((width, height + 100)))
x_img = pygame.image.load("C:/Users/nikhil/Downloads/x image.jpg")
o_img = pygame.image.load("C:/Users/nikhil/Downloads/o image.jpg")
...
def game_initiating_window():
    ...
    time.sleep(2)
    screen.fill(white)
    pygame.draw.line(screen, line_color, (width / 4, 0), (width / 4, height), 6)
    pygame.draw.line(screen, line_color, (width / 4 * 2, 0), (width / 4 * 2, height), 6)
    pygame.draw.line(screen, line_color, (width / 4 * 3, 0), (width / 4 * 3, height), 6)
    pygame.draw.line(screen, line_color, (0, height / 4), (width, height / 4), 6)
    pygame.draw.line(screen, line_color, (0, height / 4 * 2), (width, height / 4 * 2), 6)
    pygame.draw.line(screen, line_color, (0, height / 4 * 3), (width, height / 4 * 3), 6)
    pygame.display.update()
    #time.sleep(10)
    draw_status()
...
def draw_status():
    ...
    if winner is None:
        ...
        message=winner.upper()+" has Won the game!."
    if draw:
        message="Game Draw!"
...
def check_win():
    ...
    if (board[0][0] == board[1][1] == board[2][2]==board[3][3]) and (board[0][0] is not None):
        ...
        winner = board[0][3]
        pygame.draw.line(screen, (255, 255, 0), (20,380),(380,20), 4)
...
def user_click():
    ...
    if x<width/4:
        col=1
    if (x<width/4*2 and x>width/4):
        col=2
    if (x<width/4*3 and x>width/4*2):
        col=3
    ...
    if y<height/4:
        row=1
    if (y<height/4*2 and y>height/4):
        row=2
    if (y < height/ 4 * 3 and y >height/ 4*2):
        row=3
